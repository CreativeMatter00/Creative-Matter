			...
			[
				...
				function (t, n, r) {
					var e = r(2),
						...
						s = function (t, n) {
							...
							n = [];
							return a(t, n.push, { that: n }), u(r, "errors", n), r;
						};
				...
				function (t, n, r) {
					...
					(t.exports = function (t, n, r, e) {
						...
						"function" == typeof r &&
							...
							(e = p(r)).source ||
								(e.source = l.join("string" == typeof n ? n : ""))),
							t !== u
								? (o ? !c && t[n] && (i = !0) : delete t[n],
								  i ? (t[n] = r) : f(t, n, r))
								: i
								? (t[n] = r)
								: s(n, r);
				...
				function (t, n, r) {
					var e = r(6),
						...
						r = function (t, n) {
							t = c[i(t)];
							return (
								t == f || (t != u && ("function" == typeof n ? e(n) : !!n))
							);
						},
				...
				function (t, n, r) {
					var e = r(2),
						o = r(3),
						r = r(70);
					e({ global: !0 }, { Reflect: {} }), r(o.Reflect, "Reflect", !0);
				},
				function (t, n, r) {
					var e = r(20).f,
						o = r(15),
						...
						{ target: "String", proto: !0 },
						{
							replaceAll: function (t, n) {
								...
								if (null != t) {
									if (
										(r = h(t)) &&
										!~String(y("flags" in O ? t.flags : d.call(t))).indexOf("g")
									)
										throw TypeError(
